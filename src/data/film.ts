...
export const FILM_ACTS: FilmAct[] = [
  ...
  },
  {
    ...
    note: "ACT 11 — AFTER",
    add: [],
    remove: ["jacket", "bag", "cap", "hoodie", "tee", "pant", "needls", "blacktank", "tank"],
    gesture: "dissolve",
  },
];
