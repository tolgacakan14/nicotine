...
export const FILM_ACTS: FilmAct[] = [
  ...
  },
  {
    ...
    note: "ACT 13 — AFTER",
    add: [],
    remove: ["jacket", "bag", "cap", "hoodie", "tee", "pant", "pinkls", "needls", "blacktank", "tank", "whitetank"],
    gesture: "dissolve",
  },
];
