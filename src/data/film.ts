...
export const FILM_ACTS: FilmAct[] = [
  ...
  },
  {
    id: "flag-tee",
    slug: "story-flag-tee",
    headline: "STORY FLAG TEE",
    caption: "The campaign carried close to the chest.",
    note: "ACT 09 — THE FLAG",
    add: ["flagtee"],
    remove: ["tee"],
  },
  {
  ...
  },
  {
    ...
    note: "ACT 15 — AFTER",
    add: [],
    remove: ["jacket", "bag", "cap", "hoodie", "flagtee", "tee", "pant", "shorts", "pinkls", "needls", "blacktank", "tank", "whitetank"],
    gesture: "dissolve",
  },
];
